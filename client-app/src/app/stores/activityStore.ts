...
export default class ActivityStore {
    ...
    constructor() {
        ...
        reaction(
            () => this.predicate.keys(), // what to monitor
            () => {                      // what to do
    ...
    get axiosParams() {
        const params = new URLSearchParams(); // does not to be imported
    ...
    setPredicate = (predicate: string, value: string | Date) => {
        ...
        switch (predicate) {
            ...
            case 'isHost':
                ...
                break;
            case 'startDate':
                this.predicate.delete('startDate'); // if we don't delete we  don't trigger the change reaction
                this.predicate.set('startDate', value);
        }
    }

    // Method to set pagingParams
